$(document).ready(function () {
  ...
  let App = function App() {
    ...
    $('select').selectric({
      ...
      optionsItemBuilder: function (itemData) {
        ...
        return itemData.className === 'with-icon' ? '<img src="' + image + '"/>' + itemData.text : itemData.text;
      },
      labelBuilder: function (currItem) {
        let image = $(currItem.element[0]).data('image');
        return currItem.className === 'with-icon' ? '<div class="with-icon"><img src="' + image + '"/>' + currItem.text + '</div>' : currItem.text;
      }
    });
  ...
  let Cookie = function Cookie() {
    ...
    function setCookie(name, value, days) {
      ...
      document.cookie = name + '=' + value + expires + '; path=/;domain=' + COOKIE_HOST;
    }
...
!function (e) {
  ...
  var t = e(document),
    ...
    var i = this;i.element = t, i.$element = e(t), i.state = { multiple: !!i.$element.attr("multiple"), enabled: !1, opened: !1, currValue: -1, selectedIdx: -1, highlightedIdx: -1 }, i.eventTriggers = { open: i.open, close: i.close, destroy: i.destroy, refresh: i.refresh, init: i.init }, i.init(s);
  };r.prototype = { utils: { isMobile: function () {
        return (/android|ip(hone|od|ad)/i.test(navigator.userAgent)
        );
      }, escapeRegExp: function (e) {
        return e.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
      }, replaceDiacritics: function (e) {
        for (var t = o.length; t--;) e = e.toLowerCase().replace(o[t], a[t]);return e;
      }, format: function (e) {
      ...
      var t = this,
        ...
        var i = e(this);if (i.is("optgroup")) {
          var l = { element: i, label: i.prop("label"), groupDisabled: i.prop("disabled"), items: [] };i.children().each(function (s) {
            var i = e(this);l.items[s] = t.getItemData(a, i, l.groupDisabled), t.lookupItems[a] = l.items[s], a++;
          }), t.items[s] = l;
      ...
      var s = this,
        ...
        if (!s.options.allowWrap && p) return;n && (c = s.utils.previousEnabledItem(s.items, u)), a && (c = s.utils.nextEnabledItem(s.items, u)), s.highlight(c);
      ...
      var s = this;s.state.multiple && (t = e.isArray(t) && 0 === t.length ? 0 : t, t = e.isArray(t) ? Math.min.apply(Math, t) : t);var i = s.$li.eq(t).outerHeight(),
          l = s.$li[t].offsetTop,
          n = s.elements.itemsScroll.scrollTop(),
          a = l + 2 * i;s.elements.itemsScroll.scrollTop(a > n + s.itemsHeight ? a - s.itemsHeight : l - i < n ? l - i : n);
    }, open: function (s) {
      var l = this;return (!l.options.nativeOnMobile || !l.utils.isMobile()) && (l.utils.triggerCallback("BeforeOpen", l), s && (s.preventDefault(), s.stopPropagation()), void (l.state.enabled && (l.setOptionsDimensions(), e("." + l.classes.hideselect, "." + l.classes.open).children()[i]("close"), l.state.opened = !0, l.itemsHeight = l.elements.items.outerHeight(), l.itemsInnerHeight = l.elements.items.height(), l.elements.outerWrapper.addClass(l.classes.open), l.elements.input.val(""), s && "focusin" !== s.type && l.elements.input.focus(), setTimeout(function () {
  ...
  }, e.fn[i].defaults = { onChange: function (t) {
      e(t).change();
