...
6.  A partir de là deux choix s'offrent à vous : diviser votre pâte en pâtons afin de congeler la pâte (et ainsi effectuer le dernier tour simple après décongélation) ou faire le tour simple et utiliser la pâte de suite (en prenant soin de laisser celle-ci au frigo avant utilisation naturellement){{< img src="https://crokmou.com/images/tour-simple-pate-feuillet--e-invers--e.jpg" alt="pâte feuilletée inversée tour simple" >}}
